...
cv2.putText(img, 'Syra', (10, 500), font, 4, (255, 255, 255), 2, cv2.CV_AA)
...
# The first argument is for the image title and the second is for the image variable.cv2.waitKey(0)
